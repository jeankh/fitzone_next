  ...
  terms: {
    ...
    sections: {
      ar: [
        ...
        { heading: 'الدفع', body: 'نقبل الدفع عبر البطاقات الائتمانية (Visa, Mastercard)، Apple Pay، والتحويل البنكي. جميع الأسعار بالريال السعودي وتشمل الضريبة.' },
      ...
      en: [
        ...
        { heading: 'Payment', body: 'We accept payment via credit cards (Visa, Mastercard), Apple Pay, and bank transfer. All prices are in Saudi Riyals (SAR) and include tax.' },
